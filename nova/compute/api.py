...
class API(base.Base):
    ...
    def create(self, context, instance_type,
        ...
        base_options = {
            ...
            'cpu_info': type_data.get('cpu_info'),
            'xpu_arch': type_data.get('xpu_arch'),
            'xpu_info': type_data.get('xpu_info'),
            'xpus': type_data.get('xpus'),
            'net_arch': type_data.get('net_arch'),
            'net_info': type_data.get('net_info'),
