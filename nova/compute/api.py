...
class API(base.Base):
    ...
    def create(self, context, instance_type,
        ...
        base_options = {
            ...
            'cpu_arch': instance_type['cpu_arch'],
            'cpu_info': instance_type['cpu_info'],
            'xpu_arch': instance_type['xpu_arch'],
            'xpu_info': instance_type['xpu_info'],
            'xpus': instance_type['xpus'],
            'net_arch': instance_type['net_arch'],
            'net_info': instance_type['net_info'],
            'net_mbps': instance_type['net_mbps'],
