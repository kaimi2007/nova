...
class ComputeManager(manager.SchedulerDependentManager):
    ...
    def _attach_pci_devices(self, context, instance):
        instance_type = self.conductor_api.\
              instance_type_get(context, instance['instance_type_id'])
        labels = pci.get_labels_from_instance_type(instance_type)
        uuid = instance['uuid']
        host = instance['host']

        self.conductor_api.\
            pci_device_attach_to_instance_by_labels(context, host, uuid,
                                                    labels)
        instance = self._instance_update(context, uuid)
    ...
    def _build_instance(self, context, request_spec, filter_properties,
        ...
        try:
            ...
            with rt.instance_claim(context, instance, limits):
                ...
                self._attach_pci_devices(context, instance)
