...
class BareMetalDriver(driver.ComputeDriver):
    ...
    def spawn(self, context, instance, image_meta,
        ...
        self.baremetal_nodes.activate_node(var, host, instance)  # USC/ISI
...
#          'host_uuid': 'cedb9b39-9388-41df-8891-c5c9a0c0fe5f',
    ...
    def get_console_output(self, instance):  # USC/ISI
        console_log = os.path.join(FLAGS.instances_path, instance['name'],
                                   'console.log')
        host = _get_phy_host_by_instance_id(instance['id'])
        return self.baremetal_nodes.get_console_output(var, host, console_log)
