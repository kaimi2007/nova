...
class HostState(object):
    ...
    def update_from_compute_node(self, compute):
        ...
        self.free_pci_labels = [dev['label']
                                for dev in compute.get('pci_devices', [])
    ...
    def consume_from_instance(self, instance):
        ...
        requested_pci_labels = pci.get_labels_from_instance_type(inst_type)

        for label in requested_pci_labels:
            self.free_pci_labels.remove(label)
