...
def dcns_network_create(context, values):
    """Create DCNS network."""
    return IMPL. dcns_network_create(context, values)


def dcns_network_get(context, project):
    """Get DCNS network."""
    return IMPL.dcns_network_get(context, project)


def dcns_network_update(context, project, values):
    """Update DCNS network."""
    IMPL.dcns_network_update(context, project, values)


def dcns_network_delete(context, project):
    """Delete DCNS network."""
    IMPL.dcns_network_delete(context, project)


def dcns_port_add(context, project, values):
    """Add DCNS port to project"""
    return IMPL.dcns_port_add(context, project, values)


def dcns_port_get(context, project, host, nic):
    """Get DCNS port by project, host and nic"""
    return IMPL.dcns_port_get(context, project, host, nic)


def dcns_port_remove(context, project, host, nic):
    """Remove DCNS port from project by host and nic"""
    IMPL.dcns_port_remove(context, project, host, nic)
