...
# DCNS specific
DEFINE_string('use_dcns', False, 'indicating DCNS enabled or not')
DEFINE_string('dcns_topic', 'dcns', 'the topic DCNS listens on')
DEFINE_string('l2dcn_driver', 'nova.network.dcns.openflow.driver.OpenFlowDriver', 
              'DCNS L2 networking driver - OpenFlow implementation')
DEFINE_string('controller_url', '', 'URL to DCN controller/server')
DEFINE_string('controller_user', '', 'user login to controller')
DEFINE_string('controller_pass', '', 'user pass for controller login')
DEFINE_string('pce_module', 'nova.network.dcns.pce.StaticPCE', '')
DEFINE_string('topology_file', '', 'path of topology file')
DEFINE_string('static_route_file', '', 'path of static route YAML file')
DEFINE_string('host_port_map_file', '/etc/nova/dcns-port-map.conf', 
              'file for port to host:interface mapping')
DEFINE_string('dcns_net_prefix', 'dcns_test_', 'network service / request name base')
DEFINE_string('dcns_net_default_bw', '100Mbps', 'default network flow / circuit bandwidth')
