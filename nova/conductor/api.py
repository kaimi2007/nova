...
class LocalAPI(object):
    ...
    def pci_device_create(self, context, values):
        return self._manager.pci_device_create(context, values)

    def pci_device_destroy_all_on_host(self, context, host):
        return self._manager.pci_device_destroy_all_on_host(context, host)

    def pci_device_attach_to_instance_by_labels(self, context, host,
                                                instance_uuid, labels):
        params = (context, host, instance_uuid, labels)
        return self._manager.pci_device_attach_to_instance_by_labels(*params)
